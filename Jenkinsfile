    ...
    stages {
        ...
        stage('Deploy') {
            ...
            steps {
                ...
                sh "docker run -it --network host --rm -w /work -v \"$(pwd)\":/work cicd-ansible:latest ansible-playbook -i df_inventory ansible-playbook.yml -e 'DB_IMAGE=djocraveiro/pd_2021_pg:15e4ab2 WEB_IMAGE=djocraveiro/pd_2021:15e4ab2'"
